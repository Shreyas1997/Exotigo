...
<div class="main">
	<nav>
    <ul>
      <li><a href="convertible.php">Previous page</a></li>
	...
	<section id="gallery">
        <!--Use a while loop to make a table row for every DB row-->
         <?php
  $result=mysqli_query($connect,"select * from engine_specs where Mo_Name='centenario'");
?>
<h1>Engine Details</h1>
  ...
  <?php endwhile;?> 
	...
	<section id="info">
      <?php
  $result=mysqli_query($connect,"select * from safetys where Mo_Name='centenario'");
?>
<h1>Safety Features</h1>
  ...
  <?php endwhile;?> 
	...
	<section id="contacts">
    <?php
  $result=mysqli_query($connect,"select * from machanics where Mo_Name='centenario'");
?>
<h1>Mechanics</h1>
