...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<link rel="stylesheet" href="main14.css">
</head>
<body>
...
<div class="main">
	<nav>
		<ul>
			<li><a href="sedan.php">Previous Page</a></li>
...
<?php
  $result=mysqli_query($connect,"select * from engine_specs where Mo_Name='A8'");
...
<h1>Engine Details</h1>
  ...
  $result=mysqli_query($connect,"select * from safetys where Mo_Name='A8'");
...
<h1>Safety Features</h1>
  ...
  $result=mysqli_query($connect,"select * from machanics where Mo_Name='A8'");
?>
<h1>Mechanics</h1>
