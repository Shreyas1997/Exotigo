...
<div class="main">
	<nav>
		<ul>
			<li><a href="hatchback.php">Previous Page</a></li>
...
<?php
  $result=mysqli_query($connect,"select * from engine_specs where Mo_Name='Swift'");
...
<h1>Engine Details</h1>
  ...
  $result=mysqli_query($connect,"select * from safetys where Mo_Name='Swift'");
...
<h1>Safety Features</h1>
  ...
  $result=mysqli_query($connect,"select * from machanics where Mo_Name='Swift'");
?>
<h1>Mechanics</h1>
