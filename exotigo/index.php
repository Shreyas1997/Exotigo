...
<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="hovereffect">
            ...
            <div class="overlay">
              <p class="flow">
                <a href="index1.php"><h1 class="search">Select a Manufacturer</h1></a>
                <h2 class="search">OR</h2>
                <a href="index2.php"><h1 class="search">Select a Varient</h1></a>
                <h2 class="search">OR</h2>
                <a href="index3.php"><h1 class="search">Select a Model</h1></a>
            </div>
    </div>
</div>
</body>
