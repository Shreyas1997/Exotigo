...
<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="hovereffect">
            ...
            <div class="overlay">
              <p class="flow">
                <h1 class="search">Click on any Manufacturer</h1>
<?php
  $result=mysqli_query($connect,"select MName from manufacturers where MName='Lamborgini'");
  $result1=mysqli_query($connect,"select MName from manufacturers where MName='Audi'");
  $result2=mysqli_query($connect,"select MName from manufacturers where MName='Maruti Suzuki'");
?>
  <table width="500" cellpadding=5celspacing=5 border=1  align="center" class="tab">
  <tr>
  
  <th class="tname">Manufacterer Name</th>
  </tr>
  <?php while($row=mysqli_fetch_array($result)):?>
  <tr>
   
  <td style="text-align: center"><a href="Page1.php"><?php echo $row['MName'];?></a></td>
  ...
  <td style="text-align: center"><a href="Page2.php"><?php echo $row['MName'];?></a></td>
  ...
  <td style="text-align: center"><a href="Page3.php"><?php echo $row['MName'];?></a></td>
