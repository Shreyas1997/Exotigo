...
<?php
  $result=mysqli_query($connect,"select * from engine_specs where Mo_Name='q3'");
...
<h1>Engine Details</h1>
  ...
  $result=mysqli_query($connect,"select * from safetys where Mo_Name='q3'");
...
<h1>Safety Features</h1>
  ...
  $result=mysqli_query($connect,"select * from machanics where Mo_Name='q3'");
?>
<h1>Mechanics</h1>
