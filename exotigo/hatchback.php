...
<?php
  $result=mysqli_query($connect,"select Mo_Name from models where Mo_Name='Swift'");
  $result8=mysqli_query($connect,"select Mo_Name from models where Mo_Name='RS6 Avant'");
?>
  ...
  <td style="text-align: center"><a href="swift2.php"><?php echo $row['Mo_Name'];?></a></td>
  ...
  <td style="text-align: center"><a href="rs62.php"><?php echo $row['Mo_Name'];?></a></td>
